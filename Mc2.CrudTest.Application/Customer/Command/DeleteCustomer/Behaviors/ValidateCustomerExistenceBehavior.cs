...
namespace Mc2.CrudTest.Application.Customer.Command.DeleteCustomer.Behaviors;

public class ValidateCustomerExistenceBehavior : IPipelineBehavior<DeleteCustomerCommand, Unit>
{
    ...
    public async Task<Unit> Handle(
        DeleteCustomerCommand request, RequestHandlerDelegate<Unit> next, CancellationToken cancellationToken
    )
    {
