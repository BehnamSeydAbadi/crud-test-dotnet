...
public class ValidateDuplicateEmailBehavior : IPipelineBehavior<CreateCustomerCommand, Guid>
{
    ...
    public ValidateDuplicateEmailBehavior(ICustomerRepository customerRepository)
    {
    ...
    {
        var anyCustomer = await _customerRepository.AnyAsync(new GetByEmailSpecification(request.Email));
